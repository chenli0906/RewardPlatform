...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		/** NO.01 自己控制时间控件的显示和隐藏(实现点击一次，切换隐藏和显示)wangpengfei 2015-12-09 start **/
		var isShow = false;
	    ...
	    /** NO.01 add by wangpengfei 2015-12-09 end **/
	};
	...
	Datetimepicker.prototype = {
		...
		_attachEvents: function () {
			...
			if (this.isInput) { // single input
				this._events = [
					[this.element, {
						// focus:   $.proxy(this.show, this),  // NO.01 注销控件原本的显示控制
		...
		fill: function () {
			...
			if (year == endYear) {
			    //  update by 10177553 [日期点击月份上个月不可用]
