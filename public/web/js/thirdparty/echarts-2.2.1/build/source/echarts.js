...
// <Edit by 10192187><2015.11.19>
    ...
    Bubble.prototype._start = function (addShapeHandle, refreshHandle) {
        ...
        if (picWidth <= canvasWidth && picHeight <= canvasHeight) {
            resWidth = picWidth;
            resHeight = picHeight;
        } else if (canvasWidth/canvasHeight <= picWidth/picHeight){
            resWidth = canvasWidth;
            resHeight = picHeight/picWidth*resWidth;
        } else {
            resHeight = canvasHeight;
            resWidth = picWidth/picHeight*resHeight;
        }
        var img = new ImageShape({
            style : {
                x : canvasWidth/2-resWidth/2,
                y : canvasHeight/2-resHeight/2,
